            ...
            if (enableStars) {
              return (
                ...
                >
                  ...
                  <div
                    className={`card__header flex font-bold justify-between gap-3 relative `}
                  >
                    <span className={`card__label text-base text-white`}>
                      {card.label}
                    </span>
                  </div>
                  <div
                    className={`card__content flex flex-col relative font-semibold text-white`}
                  >
                    <h3
